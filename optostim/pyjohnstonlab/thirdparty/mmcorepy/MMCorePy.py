...
class CMMCore(_object):
    ...
    def loadExposureSequence(self, cameraLabel, exposureSequence_ms):
        """
        loadExposureSequence(CMMCore self, char const * cameraLabel, std::vector< double,std::allocator< double > > exposureSequence_ms)
    ...
    def loadStageSequence(self, stageLabel, positionSequence):
        """
        loadStageSequence(CMMCore self, char const * stageLabel, std::vector< double,std::allocator< double > > positionSequence)
    ...
    def getXYPosition(self, *args):
        """
        getXYPosition(CMMCore self, char const * xyStageLabel, double & x_stage, double & y_stage)
        ...
        getXYPosition(CMMCore self, double & x_stage, double & y_stage)
    ...
    def loadXYStageSequence(self, xyStageLabel, xSequence, ySequence):
        """
        loadXYStageSequence(CMMCore self, char const * xyStageLabel, std::vector< double,std::allocator< double > > xSequence, std::vector< double,std::allocator< double > > ySequence)
    ...
    def setSLMImage(self, *args):
        """
        setSLMImage(CMMCore self, char const * slmLabel, unsigned char * pixels)
        ...
        setSLMImage(CMMCore self, char const * slmLabel, imgRGB32 pixels)
    ...
    def getGalvoPosition(self, galvoLabel, x_stage, y_stage):
        """
        getGalvoPosition(CMMCore self, char const * galvoLabel, double & x_stage, double & y_stage)
        ...
        """
        return _MMCorePy.CMMCore_getGalvoPosition(self, galvoLabel, x_stage, y_stage)
